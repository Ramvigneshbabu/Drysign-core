...
<div id="loader2" class="loader2" style="display:none">
  ...
  <div class="container-fluid">
	...
	<li class="Groupsignhead">Notarization |</li>
		<li><a href="<%=appUrl %>/app/dashboard"><spring:message code="label.dash"/></a></li>
		<li class="active">Notary Sign</li>
		
	</ol>
	<ul class="list-inline col-md-6 col-sm-6 col-xs-12 nopadding rightPos">
                      <li id="save1">
                        <button type="button" id="jumpstep2" class="btn btn-primary next-step ">Submit</button>
                      </li>
                                          
                      <li id="save2" style="display: none;">
                        <button id="save_next_2" type="button" class="btn btn-primary next-step" >Next</button>
                      </li>
                       ...
                       <span class="tool-tip tooltiptext tooltip-top tooltip_css_en"><spring:message code="label.improve_readability"/></span> 
                       	...
                       	<button type="button" id="step3-button" class="btn btn-primary next-step test-btn" >Prepare</button>
    ...
    <div class="wizard signature drysign-wizard">
      <div class="wizard-inner group-sign">
        ...
        <ul class="nav nav-tabs" role="tablist">
			<li role="presentation" id="steplist1" class="disabled iconSize active" style="display:none"> 
				<a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" >
					<span class="wizardStatusIcon active"></span>
					<span class="texticon">Signatories</span>
					<span class="wizardArrowIcon active"></span>
				</a> 
			</li> 
            <li role="presentation" id="steplist2" class="iconSize"> 
...
<!-- 							</button>                     -->
                ...
                <span id="show_upload_error" class="error"></span> --%>
                  ...
                  <div class="row col-md-12 notary_radio">
                  <h3>Uploaded Documents</h3>
                  <div class="radio">
							<label> <input type="radio" name="radio-input" checked="checked"
								id="reasons1"> <span
								class="checkmark"></span>
								 <div><b>Document1-ID Proof.PDF</b></div>             
                  					<span><spring:message code="label.file_size"/> <span>2Kb</span> &nbsp;&nbsp; <spring:message code="label.date_dash"/> <span>02/10/2021</span></span>
							<hr/>
							</label>
                 ...
                 <div class="col-md-6 col-sm-12 col-xs-12"> <!-- rupali -step1 pdf view -->
                <div class="pdf_view">  
            ...
            <section>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div>
                  <div class=" row notary_name">
	      			<div class="col-md-1 col-xs-1">
	      				1
	      			</div>
	      			<div class="col-md-5 col-xs-5 nopadding">
	      				<div><label>Requester Name</label></div>
	      				<div>John Doe</div>
	      			</div>
	      			<div class="col-md-6 col-xs-5 nopadding">
	      				<div><label>Requester Name</label></div>
	      				<div>John.Doe@exelaonline.com</div>
	      			</div>
      			</div>
      			<br/>
      			<div class=" row notary_name">
                ...
                <div class="self-slide">  
                	 ...
                	 <div id="pollSlider-button"><span class="fa fa-angle-double-left"></span></div>                 		
					 	...
					 	<div class="menuIcon fullname">
                           ...
                           <div class="menuIcon notary_stamp">
                            <div id="signer-7" class="dragMe dragSigners sintatureStamp" data-signer-id="7" data-document-id="1"  title="Signature & Stamp">
                             Notary Stamp
                           </div>
                           </div>  
					 </div>	 
				...
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						<div><img src="<%=appUrl %>/images/message-bg.png" height="80px" /></div>
						 <p style="margin-top: 50px; font-size: 16px; width: 850px; max-width: 90%; margin: 0 auto">Document sent for signature</p>
						<br/>
			   			</div>
...
function DragSigner(){
    ...
    $(".drop").droppable({
      ...
      drop: function(e, ui) {
		...
		else if (document_id == 1 && signer_id == 7) {
			dropElementCnt = dropElement ? dropElement.length + 1 : 1;
            //$("#"+droppableId).append(ui.helper.clone().html('<div class="drop-select very-specific-stamp-design" id="drop-select'+uniqueGenerator+'"><a class="closeIt hideIt" style=" text-decoration: none;" id="" onclick="hideTextbox_Sig('+uniqueGenerator+','+signer_id+')" href="#clear"><span class="fa fa-times-circle"></span></a><a data-signer="signature" class="btn btn-default btn-select signature2" id="field'+uniqueGenerator+'"  data-top="'+topPosition+'" data-left="'+leftPosition+'" data-pagenumber='+droppableId+'><input type="hidden" class="btn-select-priority" id="fieldpriorityvalue'+uniqueGenerator+'"  value="" /><input type="hidden" class="btn-select-input" id="fieldvalue'+uniqueGenerator+'"  value="" /><input type="hidden" class="btn-select-email" id="fieldemailvalue'+uniqueGenerator+'"  value="" /><span class="btn-select-value">Signature</span><span class="btn-select-arrow fa fa-angle-down"></span></a><div class="stamp groupSignStamp" id="mySpanImg'+uniqueGenerator+'"  data-top="0" data-left="0" data-width="0" data-height="0" data-stamp="data-digitalStamp" data-fontSize="'+fontSize+'"><span class="span1">Digitally signed by</span><br/><span class="span2">Name</span><br/><span class="span3">Date</span></div></div>'));
	
			$("#"+droppableId).append(ui.helper.clone().html('<div class="drop-select very-specific-stamp-design element_'+ uniqueGenerator +'" id="drop-select'+uniqueGenerator+'"><a class="closeIt hideIt" style=" text-decoration: none;" id="" onclick="hideTextbox_Sig('+uniqueGenerator+','+signer_id+')" href="#clear"><span class="fa fa-times-circle"></span></a><a data-signer="signature" class="btn btn-default btn-select signature2" id="field'+uniqueGenerator+'"  data-top="'+topPosition+'" data-left="'+leftPosition+'" data-pagenumber="'+droppableId+'"><input type="hidden" class="btn-select-priority" id="fieldpriorityvalue'+uniqueGenerator+'"  value="" /><input type="hidden" class="btn-select-input" id="fieldvalue'+uniqueGenerator+'"  value="" /><input type="hidden" class="btn-select-email" id="fieldemailvalue'+uniqueGenerator+'"  value="" /><div class="field111_stamp"><span class="btn-select-value">Notary Signature</span><span class="btn-select-arrow fa fa-angle-down"></span></div></a><div class="notaryStamp"  data-top="0" data-left="0" data-width="0" data-height="0" data-stamp="data-digitalStamp" data-fontSize="'+fontSize+'"></div></div>'));

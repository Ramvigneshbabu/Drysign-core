            ...
            <div class="row">
               ...
               <div class="row paddT100" id="show_key_form">
 				...
 				<div class="col-xs-12 text-center">
                        <button type="button" id="loader_key" onclick="register();" class="btn has-spinner btn-primary">GET AN API KEY</button>
                     </div>
...
// 	            	$("#error-alert").addClass('hidden');
	                if(callback.msg== '1' || callback.msg== 1){
						...
						$("#registerdmessage").html(<c:out value="callback.msg"></c:out>);

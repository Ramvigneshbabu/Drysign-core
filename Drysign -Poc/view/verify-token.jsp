...
<html>
   <head>
      <title>OTP Verify | DrySign</title>
...
<div class="modal fade" id="PModal" tabindex="-1" role="dialog"
 ...
 $(document).ready(function() {
	 //console.log(email);
	 	var xhttp = new XMLHttpRequest();
	 	    ...
	 	    xhttp.open("GET", "<%= appUrl %>/otp/verify?email="+email, true);  
 ...
 <%=appUrl %>+"/DrySign/otpVerify?email="+email+"&token="+token

	...
	<ol class="breadcrumb col-md-6 col-sm-6 col-xs-12">
		...
		<li class="active"><spring:message code="label.grp_sgn"/></li>
					...
					<ul class="list-inline col-md-6 col-sm-6 col-xs-12 nopadding rightPos">
						<li id="save1" style="display: none;">
							<button type="button" id="jumpstep2"
								class="btn btn-primary next-step " disabled>
								<spring:message code="label.svnxt" />
							</button>
						</li>
						...
						<button class="btn btn-light" id="bulkUploadBtn" data-toggle="modal" data-backdrop="static" data-keyboard="false"  data-target="#bulkUpload"><spring:message code="label.bulk_upload" /></button>
							<button id="save_next_2" type="button"
								class="btn btn-primary next-step" disabled>
								<spring:message code="label.svnxt" />
							</button>
						</li>
						...
						<li id="save3" style="display: none;">
							<div class="tooltip1 tooltip-w" style="display: none;">
								<button class="btn btn-light" id="qa" value="1"
									onclick="qualityImprove(this.value);">
									<spring:message code="label.enhance" />
								...
								<button type="button" id="step3-button" onclick="jumpstep2(3)"
									class="btn btn-primary next-step test-btn" disabled>
									<spring:message code="label.svnxt" />
								</button>
						...
						<li id="send4" style="display: none;">
							<div class="tooltip1 tooltip-w">
								<button id="send" type="button" onclick="saveGroupSign();"
									class="btn btn-primary next-step">
									<spring:message code="label.sendmail" />
								</button>
				...
				<div class="wizard-inner group-sign">
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation" id="steplist1" class="disabled iconSize">
							...
							role="tab"> <span class="wizardStatusIcon active"></span> <span
								class="texticon"><spring:message code="label.pre_upload"/></span> <span
								class="wizardArrowIcon active"></span>
						</a>
						</li>
						<li role="presentation" id="steplist2" class="disabled iconSize">
							<a href="#step2" data-toggle="tab" aria-controls="step2"
							role="tab"> <span class="wizardStatusIcon"></span> <span
								class="texticon"><spring:message code="label.add_signa"/></span> <span
								class="wizardArrowIcon"></span>
						</a>
						</li>
						<li role="presentation" id="steplist3" class="disabled iconSize">
							<a href="#step3" data-toggle="tab" aria-controls="step3"
							role="tab"> <span class="wizardStatusIcon"></span> <span
								class="texticon"><spring:message code="label.prepare"/></span> <span class="wizardArrowIcon"></span>
						</a>
						</li>
						<li role="presentation" id="steplist4" class="disabled iconSize">
							<a href="#step4" data-toggle="tab" aria-controls="step4"
							role="tab"> <span class="wizardStatusIcon"></span> <span
								class="texticon"><spring:message code="label.recipients"/></span>
						</a>
						</li>
					</ul>
				</div>
				<div class="tab-content accordion">
					...
					<div class="tab-pane" role="tabpanel" id="step1">
								...
								<div class="row_center">
									...
									<div class="col-md-6 col-sm-8 col-xs-12 col-centered">
												...
												<div class="upload-fild col-lg-6 col-md-6 col-sm-6 col-xs-6">
													<div class="custom-file-upload">
														<div class="icon fileUploadIcon">
															<i class="fa fa-cloud-upload" id="cloudUpload_sign"
																aria-hidden="true"></i> <input id="fileupload"
																type="file" style="border: none !important" name="files"
																accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.rtf,.jpg,.jpeg,.gif,.bmp,.png,.htm,.html,.tiff">
														</div>
														<span><spring:message code="label.drg_drp_brw"/> </span>
													</div>
												</div>
												<div class="col-md-6 col-xs-6 nopadding">
													<c:forTokens items="${features1 }" delims=","
														var="feature1">


														<c:if test="${feature1 eq 1 }">
															<button type="submit" class="tooltip1" id="pick"
																style="border: 0; background: transparent;">
																<span class="tooltiptext tooltip-bottom"><spring:message
																		code="label.gd" /></span> <img src="<%=appUrl %>/images/Drive.png" width="25" height="25" alt="submit" />
															</button>
														</c:if>
														<c:if test="${feature1 eq 2 }">
															<button data-placement="top" type="submit"
																class="tooltip1" id="dropbox"
																style="border: 0; background: transparent;">
																<span class="tooltiptext tooltip-bottom"><spring:message
																		code="label.db" /></span><img src="<%=appUrl %>/images/Dropbox.svg" width="25" height="25" alt="submit" />
															</button>
														</c:if>
														<c:if test="${feature1 eq 3 }">
															<button data-placement="top" type="submit"
																class="tooltip1" id="onedrive"
																onclick="launchOneDrivePicker()"
																style="border: 0; background: transparent;">
																<span class="tooltiptext tooltip-bottom"><spring:message
																		code="label.od" /></span><img src="<%=appUrl %>/images/Cloud.svg" width="30" height="30" alt="submit" />
															</button>
														</c:if>

													</c:forTokens>
													<br /> <span class="uploadFromIcon"><spring:message code="label.or_upload"/> </span>
												</div>
										...
										<div class="uploadSuccessHeading row">
											...
											<div>
												<span id="uploadSuccess"></span> <span id="remove-icon"><span>
											</div>
						...
						<div>
							...
							<input type="text" id="filename" type="text"
								style="display: none;"> <input type="button" id="save"
								value="save" onclick="download()" style="display: none;">
							<!-- </button> -->
							...
							<section>
								<div class="row">
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div>
											<div class="addScroll">
												<table class=" Group-Sign-addremove table-striped"
													id="diagnosis_list">
													
													<tbody>
														<tr id='addr0'>
															<td class='priority col-md-1 col-sm-1 col-xs-1'
																id="priority0">1</td>
															<td class="col-md-5 col-sm-5 col-xs-5"><label><spring:message
																		code="label.sgnname" /></label> <input type="text"
																class="signerNameClass_CopyPaste" autocomplete='off' name='signername'
																id="signername0" myattr=0
																placeholder='<spring:message code="label.sgnname"/>'
																class="form-control" maxlength="30"
																onchange="validateSignersName();" /> <span
																class="required error" id="signervalidname0"
																style="display: none"><spring:message
																		code="label.enter_signatory" /> </span> <span
																class="required error" id="signeremptyname0"
																style="display: none"><spring:message
																		code="label.empty_signatory" /> </span></td>
															<td class="col-md-5 col-sm-5 col-xs-5"><label><spring:message
																		code="label.login-email" /></label> <input type="text"
																name='signeremail' autocomplete='off' id='signeremail0'
																placeholder='<spring:message code="label.email_address"/>'
																class="form-control" maxlength="70"
																onchange="validateSignersEmail();" /> <span
																class="required error" id="signervalidemail0"
																style="display: none"><spring:message
																		code="label.email_msgrequired" /></span></td>
											...
											<div class="text-left margTB15 div-add-more">
												<a class=".head3_1" id="add_row" href="#"><i
													class="fa fa-plus-circle plusIcongroup" aria-hidden="true"></i>
												<spring:message code="label.admore" /></a>
												...
												<!-- &nbsp 	 <a class="" id="add_row" href="#">Add CC</a> -->
											</div>
											<div class="row">
												<div class="col-md-12 text-left nopadding">
													<div
														class="checkbox checkbox-primary col-md-12 col-sm-12 col-xs-12">
														<c:forTokens items="${features1 }" delims=","
															var="feature1">
															<c:if test="${feature1 eq 13 }">
																<input type="checkbox"
																	onclick="enable_disable_proirity();" class="filled-in"
																	id="checkbox2">
																<label for="checkbox2"> <spring:message
																		code="label.set_priorty" />
																</label>
															</c:if>
														</c:forTokens>
													...
													<div
														...
														<input type="checkbox" class="filled-in" id="checkbox"
															checked> <label for="checkbox"><spring:message
																code="label.send-tem" /></label>
													</div>
													<div
														class="checkbox checkbox-primary col-md-12 col-sm-12 col-xs-12">
														<input type="checkbox" class="filled-in"
															onclick="enable_password_protect();" id="checkbox1">
														<label for="checkbox1"><spring:message
																code="label.password_protect" /></label>
													</div>
													<div class="col-md-6 col-sm-12 col-xs-12">
														<span toggle="#doc_key"
															class="fa fa-fw fa-eye field-icon_GroupSign toggle-password pull-right"
															id="toggle_password_eye"></span> <input type="password"
															class="doc_key" name="doc_key"
															placeholder="<spring:message code="label.pls_ent_pwd"/>"
															id="doc_key" class="form-control" autocomplete="off"
											...
											<input type="hidden" id="add-row" value="1" /> <input
												type="hidden" id="total-row" value="1" />
										...
										<div class="self-slide">
											<div class="pollSlider">
												...
												<div class="header-text">
													<div class="menuIcon fields"></div>
													<span><spring:message code="label.fields"/></span>
												</div>
												<div class="text-center">
												<div class="menuIcon fullname">
													<div id="signer-1" class="dragMe dragSigners"
														data-signer-id="1" data-document-id="1" title="Full name">
														
														<spring:message code="label.slf_name" />
													</div>
												</div>
												<div class="menuIcon date">
													<div id="signer-2" class="dragMe dragSigners"
														data-signer-id="2" data-document-id="1" title="Date">
														
														<spring:message code="label.slf_date" />
													</div>
												</div>
												<div class="menuIcon textbox">
													<div id="signer-4" class="dragMe dragSigners"
														data-signer-id="4" data-document-id="1" title="Textbox">
														TEXTBOX
													</div>
												</div>
												<div class="menuIcon initials">
													<div id="signer-6" class="dragMe dragSigners"
														data-signer-id="6" data-document-id="1" title="Initials">
														INITIALS
													</div>
													</div>
													<div class="menuIcon sign">
													<div id="signer-3" class="dragMe dragSigners"
														data-signer-id="3" data-document-id="1" title="Signature">
														
														<spring:message code="label.edt_sgn" />
													</div>
													</div>
													<div class="menuIcon sign_stamp">
													<div id="signer-5" class="dragMe dragSigners"
														data-signer-id="5" data-document-id="1" title="Signature & Stamp">
											...
											<div>
												...
												<div class="row ">
													<div class="col-md-4 col-sm-4 col-xs-12 form-group">
														<label><spring:message code="label.slffrm_add" /><span
															class="redstar">*</span></label> <input type="text" id="from"
															value="<c:out value="<%=registration.getEmail()%>"></c:out>"
															readonly class="form-control validate">
													</div>													
													<div
														class="col-md-4 col-sm-4 col-xs-12 form-group tooltip1">
														<label><spring:message code="label.cc_email" /></label> <input
															type="text" name="cc" id="cc" autocomplete='off'
															class="form-control validate"> <span
															class="tool-tip tooltiptext tooltip-down tooltip_css"
															id="ttip"></span>
													</div>													
													<div class="col-md-4 col-sm-4 col-xs-12 form-group">
														<label><spring:message code="label.slf_sub" /><span
															class="redstar">*</span></label> <input type="text"
															name="subject" id="subject" autocomplete='off' maxlength=255
															class="form-control validate">
													</div>
												</div>
												<div class="row">
													<div class="col-md-12 col-sm-12 col-xs-12 form-group">
														<label><spring:message code="label.slf_msg" /><span
												...
												<div class="row col-lg-12">
													<span id="ckeditor_error" class="error"><spring:message
															code="label.slf_msgval" /></span>
												</div>
	   ...
	   <p style="margin-top: 50px; font-size: 16px; width: 850px; max-width: 90%; margin: 0 auto"><spring:message code="label.msg_em_succ"/> > <a href="<%=appUrl %>/app/myfiles?tab=outforsign"> <spring:message code="label.dash_outdoc"/>.</a>
				   <spring:message code="label.grp_sucessmsg"/> > <a href="<%=appUrl %>/app/myfiles?tab=completed"><spring:message code="label.cmplt_doc"/>.</a>
		</p>
		 	...
		 	<div class="row uploadFileSelfSignGroupSign text-center">                                     
                        ...
                        <div class="icon fileUploadIcon">
     					...
     					<!-- //below change done to resolve DrySign: 1465 issue by Rupali.Shinde  -->
   						<span><spring:message code="label.browse"/> </span><br>
...
var appURL="";
	$(document).ready(function () {
	    ...
	    $("#show-selfsign-success").hide();
	   	...
	   	var uploadedDate='<c:out value="${upload_date}"></c:out>';
	   	var file_size='<c:out value="${fileSize}"></c:out>';
	  
	   //	alert(dragList);
	   //$("#document-reader1").html("");
	   $("#uploadSuccess").html(docName);
	   var fileSizeKB = convertSize(file_size);
	   $("#fileSize").html(fileSizeKB);
       $("#uploadDate").html(uploadedDate);
...
upload_bulk.addEventListener('change', function(){
	...
	// $("#file-chosen").html(this.files1[0].name);
	//  var fileNa = this.files1[0].name;
	//var fileName=$(".file-upload-input").val();
	var fileName = $('#upload_bulk')[0].files[0].name;
	
	 var validExts = new Array(".csv");
	 var validExts1 = ".csv,.xlsx";
	 var validExts2 = new Array(".xlsx");
			    ...
			    //    if(data.originalFiles[0]['type'].length == 0){
			      //  	 uploadErrors.push('<spring:message code="label.onl_pdf"/>');
			        ...
			        //if(data.originalFiles[0]['type'].length && !acceptFileTypes.test(data.originalFiles[0]['type'])) {
			          //  uploadErrors.push('<spring:message code="label.onl_pdf"/>');
			        //}
			        if(data.originalFiles[0]['size'].length && data.originalFiles[0]['size'] > 26214400) {
			            uploadErrors.push('<spring:message code="label.mx_file"/>');
			        }
...
function hideBulkUploadPopUp(){
	//rupali -cancel button for bulk upload
	$("#bulkUpload").hide();
	$("#file-chosen").html("");
	$('#csverror').html("");
	$('#upload_bulk').val("");
...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/jquery-ui.min.js"></script> -->
 <input type="hidden" id="count_row" value="<c:out value="${signercount}"></c:out>"/>
         	           			...
         	           			for(var cnt =0;cnt<totalBulkCount;cnt++){
         	           			      var sigName = response.mytestList[cnt].signerName;
         	           						if(setpriority == 1){	
         	           								...
         	           								$('#addr'+i).html("<td class='priority col-md-1 col-sm-1 col-xs-1' id='priority"+(i)+"'>"+ (j+1) +"</td><td class='col-md-5 col-sm-5 col-xs-5'><div><label><spring:message code='label.sgnname'/></label></div><input name='signername' id='signername"+(i)+"' autocomplete='off' type='text' placeholder='<spring:message code="label.sgnname"/>' class='form-control input-md namevalidation signerNameClass_CopyPaste' maxlength='30' onchange='validateSignersName();' value='"+sigName+"'/><span class='required error' id='signervalidname"+(i)+"' style='display:none'><spring:message code="label.enter_signatory"/></span><span class='required' id='signeremptyname"+(i)+"' style='display:none'><spring:message code="label.empty_signatory"/></span> </td><td class='col-md-5 col-sm-5 col-xs-5'><div><label><spring:message code='label.login-email'/></label> </div><input  name='signeremail' id='signeremail"+(i)+"' autocomplete='off' maxlength='70'  type='text' placeholder='<spring:message code="label.login-email"/>' class='form-control input-md' onchange='validateSignersEmail();' value="+response.mytestList[cnt].signerEmail+"><span class='required error' id='signervalidemail"+(i)+"' style='display:none'>Please enter valid email address </span><span class='required error' id='signervalidemail_spacechk"+(i)+"' style='display:none'>Please enter valid email address </span></td><td class='col-md-1 col-sm-1 col-xs-1 pull-right'><i class='fa fa-trash-o pull-right badge-workCancel trash_new' aria-hidden='true'></i></td>");	 
         	           								 $(".signerNameClass_CopyPaste").bind('paste input', removeAlphaChars);
         	           									$('#signername'+i).focus().setCursorPosition(1);
         	           								j++;
         	           								...
         	           								$(".priority_header").hide();
         	           								 $('#addr'+i).html("<td class='priority col-md-1 col-sm-1 col-xs-1' id='priority"+(i)+"' style='display:none'>"+ (j+1) +"</td><td class='col-md-5 col-sm-5 col-xs-5'><div><label><spring:message code='label.sgnname'/></label> </div><input name='signername' id='signername"+(i)+"'  autocomplete='off' type='text' placeholder='<spring:message code="label.sgnname"/>' class='form-control input-md namevalidation signerNameClass_CopyPaste' maxlength='30' onchange='validateSignersName();' value='"+sigName+"'/><span class='required error' id='signervalidname"+(i)+"' style='display:none'><spring:message code="label.enter_signatory"/></span><span class='required' id='signeremptyname"+(i)+"' style='display:none'><spring:message code="label.empty_signatory"/></span> </td><td class='col-md-5 col-sm-5 col-xs-5'><div><label><spring:message code='label.login-email'/></label> </div><input  name='signeremail' id='signeremail"+(i)+"' maxlength='70'  autocomplete='off' type='text' placeholder='<spring:message code="label.login-email"/>' class='form-control input-md' onchange='validateSignersEmail();' value="+response.mytestList[cnt].signerEmail+"><span class='required' id='signervalidemail"+(i)+"' style='display:none'>Please enter valid email address </span><span class='required error' id='signervalidemail_spacechk"+(i)+"' style='display:none'>Please enter valid email address </span></td><td class='col-md-1 col-sm-1 col-xs-1 pull-right'><i class='fa fa-trash-o pull-right badge-workCancel trash_new' aria-hidden='true'></i></td>");
         	           								 $(".signerNameClass_CopyPaste").bind('paste input', removeAlphaChars);
         	           									$('#signername'+i).focus().setCursorPosition(1);
         	           								j++;
 ...
 function getSignerList(){
        ...
        success : function(response) {        	
        	 ...
        	 if($("#isCountryCode").val()!="IN"){
       		...
       		var docFlag = '0';
       		var keyVali = '0';
       		console.log("DocFlag Init()::"+docFlag);
       		  $.each(response, function( key, value ) {
       			 var keyVali = key;
       		   	 var j=parseInt($("#add-row").val());
       			 var setpriority=$("#setpriority").val();
       			 ...
       			 if(key == 0){
       				    ...
       				    docFlag=<c:out value="value.docFlag"></c:out>;
       		...
       		var isValid = true;  
       		console.log("DocFlag final::"+docFlag);
       		//console.log("DocFlag::"+value);
  			 if(docFlag == "1"){
	...
	$('table').on('click','.badge-workCancel',function() {
		...
		if(flag == "draft" && dragList !=""){
			...
			if(cnt==1){
				...
				$.confirm({
					title:"Delete",
				    content: '<spring:message code="label.dlt_signeename"/>',   
					 buttons: {
						 Cancel: {
						        btnClass: 'btn-light',
						       action: function(){ 
...
function jumpstep2(stepNumber){
	...
	if(stepNumber == 3){
		var generatorLength=$("#generator").val();
		//alert("generatorLength:"+generatorLength);
				...
				for(var i=1; i<generatorLength; i++) {
					...
					var fieldType=$("#field"+i).attr("data-signer");
		 			...
		 			if(fieldType == "name"){
		 /*				var field = $("#field"+i).offset();	//anchor tag id of data-signer=signature
						var sleftPosition=0; var stopPosition =0; 
						var swidth=0; var sheight=0;
					
					 	var parent = $("#document-reader").offset();
					 	
					 	if(parent != null || parent != undefined || parent != "undefined"){
						  
						   	sleftPosition  = parent.left - field.left;	//sign left
						   	stopPosition   = parent.top - field.top;		//sign top
						   	swidth=  $("#field"+i).width();				//sign width
							sheight = $("#field"+i).height();			//sign height
							
							$("#field"+i).data("data-top", stopPosition); // yes change you atribute
					        $("#field"+i).data("data-left", sleftPosition); // yes change you atribute
							$("#field"+i).data("data-width", swidth); // sign width atribute
					        $("#field"+i).data("data-height", sheight); // sign height atribute
							
						   console.log("--------------------------------------------------");
						   console.log(i+"==NAME :sleftPosition:"+sleftPosition);
				           console.log(i+"==NAME :stopPosition:"+stopPosition);
				           console.log(i+"==NAME :swidth:"+$("#field"+i).data("data-width"));
				           console.log(i+"==NAME :sheight:"+$("#field"+i).data("data-height"));
				           var fontSize = $("#field"+i).css("font-size");
				           //console.log(i+"==NAME :fontSize:"+fontSize);
				        
						}*/ 
					} 	
					else if(fieldType == "signature"){	
					
						var parent = $("#document-reader").offset(); //common pos to be considered for all fields
						//----------------------SIGN-----------------------------------//
						var sign = $("#field"+i).offset();	//anchor tag id of data-signer=signature
						var sleftPosition=0; var stopPosition =0; 
						var swidth=0; var sheight=0;
						
						//----------------------STAMP-----------------------------------//
						var stfieldType=$("#mySpanImg"+i).attr("data-stamp");
						var x = $("#mySpanImg"+i).offset();	//stamp
						var leftPosition=0; var  topPosition =0;
						var xwidth=0;  var xheight =0;
	...
	$.ajax({
        ...
        success : function(response) {
         	if(response != 'failed'){
        			//alert("success");
        			$("#stepNumber").val(2);
        			//var docreader2 = $("#document-reader1").val();
        			//alert("DocReader 2 :"+docreader2);
        			if(stepNumber == 2){
        			$("#document-reader2").html("");
        			getuploadFileImg(2);
        			/* if($("#isCountryCode").val()=="IN"){
    ...
    $(".drop").droppable({
      ...
      drop: function(e, ui) {
        ...
        if(chekForDraggingElementasitis(dragEl,droppableId,ui,topPosition,leftPosition,innertext,signer_id)){
        	//console.log('in chekForDraggingElementasitis');
        	//console.log('dragEl : '+dragEl + ', droppableId : '+droppableId +', topPosition : '+topPosition + ', leftPosition : '+ leftPosition + ', innertext : '+ innertext + ', signer_id : '+signer_id );
        	return;
        }
        ...
        if (document_id == 1 && signer_id == 1) {
           ...
           $('.element_'+ uniqueGenerator).parents("div.dragMe").attr('id', 'fieldPosition'+uniqueGenerator+'');
        ...
        dragEl.draggable({               
    		...
    		//stack: '.dragSigners',
    		drop: function (event, ui) {
    		console.log('dragEl.draggable drop');
              $(ui.draggable).remove();
            }
    });
  ...
  function DragMe(){
        ...
        stop: function(event, ui) {
          ...
          var dropElement = $('.drop .dragMe');
         	...
         	for(i = 0; i < dropElement.length + 1; i++){
         		console.log($(dropElement[i]).find( ".field111" ));
         		console.log($(dropElement[i]).find(".field111").width()-50);
         		$(dropElement[i]).find( ".field111" ).css( "font-size", ( $(dropElement[i]).find(".field111").width()-45) + "%" );
          	/* $(dropElement[i]).find(".field111_stamp").css( "font-size", ( $(dropElement[i]).find(".field111_stamp").width()-50) + "%" );
          	$(dropElement[i]).find(".span1").css( "font-size", ( $(dropElement[i]).find(".groupSignStamp").width()-135) + "%" );
          	$(dropElement[i]).find(".span2").css( "font-size", ( $(dropElement[i]).find(".groupSignStamp").width()-100) + "%" );
          	$(dropElement[i]).find(".span3").css( "font-size", ( $(dropElement[i]).find(".groupSignStamp").width()-135) + "%" ); */
    ...
    $(".drop .dragMe").resizable({ 
        ...
        {	
    		...
    		$("#"+resizeId).find(".span2").css( "font-size", ( $("#"+resizeId).width()/2 - 110) + "%" );
...
function validateSignersName(){
	...
	$("input[name='signername']").each(function() {
		$(this).bind('paste input', removeAlphaChars);
...
function saveGroupSign(){
	...
	jsonArray.push(item);
			...
			console.log("FINAL ITEMS:"+JSON.stringify(jsonArray)) //digital stamp
			var btn='#send';
				$.ajax({
					type : "POST",
...
function signerValidate(rowNum){
	var isValid = true;
	$("input[name='signername']").each(function() {
		if ($.trim($(this).val()) == '') {
			isValid = false;
	...
	$("input[name='signeremail']").each(function() {
		...
		//	alert(rowNum);
			$('#signervalidemail'+rowNum).show();
			$('#signervalidemail'+rowNum).html('<spring:message code="label.email_present"/>').fadeOut(10000);
		}
		else {
			$(this).css({
				"border": "",

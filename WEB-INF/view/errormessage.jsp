...
<nav class="navbar navbar-default inner-header">
  <div class="container-fluid"> 
    ...
    <div class="navbar-header" style="width: 100%">
      ...
      <a class="navbar-brand removecursor hidden-xs" href="<%=hostUrl %>"><img
...
<div class="container-fluid" style="margin-top: 100px;">
	<div class="Content-wh-module text-center" style="margin-top: 20px;">
	   ...
	   <h4 class="message-text text-color-burmoda"><spring:message code="label.some_went_wrong"/></h4>
	  <a href="#" style="margin-top: 50px;" class="btn btn-primary font-24"><spring:message code="label.ok"/></a>
	</div>   
</div>

...
/*Db Queries for version 1.6*/
ALTER TABLE sb_subscription ALTER COLUMN user_id varchar(255)


ALTER TABLE sb_subscription ADD updated_date datetime NULL

update sb_subscription set updated_date=subscription_start_date
...
SELECT TOP 1
		...
		WHERE s.status = 1
		AND (s.user_id = @stringId OR s.user_id LIKE @stringId + ',%' OR s.user_id LIKE '%,' + @stringId + ',%' OR s.user_id LIKE '%,' + @stringId )--s.user_id = 
		ORDER BY s.updated_date DESC
		

CREATE TABLE tbmst_sb_features (
  id int IDENTITY(1,1),
  name varchar(250) NOT NULL,
  message text,
  created_date datetime DEFAULT NULL,
...
insert into tbmst_sb_features(name,message,created_date) values('GoogleDrive','GoogleDrive','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('DropBox','DropBox','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('OneDrive','OneDrive','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('Self sign','Self sign','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('Group Sign','Group Sign','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('Profile','Profile','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('Summary','Summary','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('Track documents history','Track documents history','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('View documents','View documents','2018-03-07 12:22:20.233')
insert into tbmst_sb_features(name,message,created_date) values('Download documents','Download documents','2018-03-07 12:22:20.233')

CREATE TABLE tbtrn_action_history (
  id int IDENTITY(1,1),
  document_id int DEFAULT NULL,
  signer_id int DEFAULT NULL,
  type VARCHAR(255),
